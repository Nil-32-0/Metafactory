...
StartupEvents.registry("item", event => {
    ...
    let circuitTypes = {
        ...
        "processor_zetta": {suffix: "Zettacomputer", rankAddition: 4},
    ...
    Object.keys(expandedThemes).forEach(theme => {
        ["processor_zetta", "processor_core"].forEach(type => {
    ...
    event.create("gtmetx:basic_arcane_circuit").texture("gtmetx:item/circuits/arcane/basic").tag("kubejs:needs_texture")
        .tag("gtceu:circuits/magic").tag("gtceu:circuits/magic/lv").tooltip("§7Your Second Circuit").tooltip("§cLV-Tier Circuit");
    event.create("gtmetx:good_arcane_circuit").texture("gtmetx:item/circuits/arcane/good").tag("kubejs:needs_texture")
        .tag("gtceu:circuits/magic").tag("gtceu:circuits/magic/mv").tooltip("§7Your Fourth Circuit").tooltip("§cMV-Tier Circuit");
    event.create("gtmetx:basic_mystic_circuit").texture("gtmetx:item/circuits/mystic/basic").tag("kubejs:needs_texture")
        .tag("gtceu:circuits/magic").tag("gtceu:circuits/magic/lv").tooltip("§7Smaller and faster").tooltip("§6LV-Tier Circuit");
    event.create("gtmetx:good_mystic_circuit").texture("gtmetx:item/circuits/mystic/good").tag("kubejs:needs_texture")
        .tag("gtceu:circuits/magic").tag("gtceu:circuits/magic/mv").tooltip("§7Smaller and faster").tooltip("§6MV-Tier Circuit");
    event.create("gtmetx:advanced_mystic_circuit").texture("gtmetx:item/circuits/mystic/advanced").tag("kubejs:needs_texture")
        .tag("gtceu:circuits/magic").tag("gtceu:circuits/magic/hv").tooltip("§7Smaller and faster").tooltip("§6HV-Tier Circuit");

    event.create("gtmetx:aether_tube").texture("gtmetx:item/circuits/aether_tube").tag("kubejs:needs_texture")
        .tag("gtceu:circuits/magic").tag("gtceu:circuits/magic/ulv").tooltip("§7Supposedly impossible").tooltip("§cULV-Tier Circuit");
    event.create("gtmetx:mana_chip").displayName("MANA Chip").texture("gtmetx:item/circuits/mana_chip").tag("kubejs:needs_texture")
